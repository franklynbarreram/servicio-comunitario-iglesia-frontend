				...
				<Link href={href}>
					<button
						...
						className={clsx(
							...
							//fill
							{
								'text-gray-0 bg-primary border-primary':
							...
							//not fill
							{ 'text-primary border-primary': !fill && !social && !secondary },
							{
								'text-gray-500 border-gray-500 hover:bg-gray-500 hover:text-white':
									!fill && !social && secondary && !danger,
							},
							{
								'hover:bg-primary hover:text-gray-0 ':
									!fill && !social && !disabled && !secondary && !danger,
							},
							//disabled
							{
								'disabled:bg-primary disabled:text-gray-0 disabled:opacity-50':
									!social,
							},
							//facebook
