...
const EventosPrecamporee = ({ idCamporee }: EventosPrecamporeeProps) => {
            ...
            >
              {allPrecamporee.map((item: any) => {
                const itemsPrecamporeeCard = [
                  {
                    icon: Icons.calendar,
                    title: `${item?.fecha_inicio} a ${item?.fecha_fin}`,
                  },
                  {
                    icon: Icons.medalla,
                    title: `${item?.puntaje_maximo} pts ${
                  ...
                  >
                    ...
                    <div>
                      <div className="-mt-px flex divide-x divide-gray-200">
                        ...
                        <Restricted
                          module={ModuleEnums.EVENTO_PRECAMPOREE_DETAIL}
