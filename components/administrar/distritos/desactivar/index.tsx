...
const DesactivarDistrito = ({ data, hide, refetch }: any) => {
  ...
  const onDelete = () => {
    setIsLoading(true);
    DistritosServices.delete(data?.id)
      .then((response: any) => {
        ...
        <>
          <div className="mt-10 text-left">
            ...
            <p className="text-center text-base text-gray-500 mt-4">
              Si desactivas el distrito, sus iglesias y clubes serán
              desactivados y sus miembros dados de baja
            </p>
          </div>
...
export default DesactivarDistrito;
