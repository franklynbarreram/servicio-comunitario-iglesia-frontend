...
const EditIglesia = ({ data, hide, refetch }: any) => {
  const [selectValueAncianos, setSelectValueAncianos] = React.useState<{
    value: Number;
    label: string;
  }>({ value: data.cedula_primer_anciano, label: data.primer_anciano });
  const [selectValueDistritos, setSelectValueDistritos] = React.useState<{
    value: Number;
    label: string;
  }>({
  ...
  return (
    <div className="text-center">
      <h2 className="text-4xl font-bold">Crear Iglesia</h2>
